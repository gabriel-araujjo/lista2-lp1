...
int main (int argc, char **argv) {
	std::cout << "Testando soma de sequencia harmônica (implementação iterativa) " << std::endl;
	test_cases("test/cases/soma_harmonicas_cases.txt", soma_sequencia_harmonica_i);

	std::cout << std::endl << "Testando soma de sequencia do item b (implementação iterativa) " << std::endl;
	test_cases("test/cases/soma_b_cases.txt", soma_sequencia_b_i);
}
